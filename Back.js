const quizData = [
  {
    question: "An internal medicine attending physician asks a medical student to place the bell of her stethoscope on the triangle of ausculation to hear a patients breathing sound. Which of the following structures make up the boundaries of the triangle ?",
    ...
    e: "Longissmus, rhomboids, vertebral spinous process",
    correct: "b",
  },
  {
    question: "The forearm consists of....",
    a: "humerous only",
    b: "radius, ulna and wrists",
...
submitBtn.addEventListener('click', () => {
  ...
  if(answer) {
    ...
    if(currentQuiz < quizData.length) {
      ...
      <button onclick='window.location.href="quiz-test.html" '> Reload </button>
      `
