const quizData = [
  {
    question: "Which one of the following is mostly responsible for the maintenance of protein secondary structure?",
    a: "Hydrophobic interactions",
    b: "van der Waals forces",
    c: "Hydrogen Bonds",
    d: "Disulphide cross-links",
    e: "Salt bridges",
    correct: "c",
  },
  {
...
submitBtn.addEventListener('click', () => {
  ...
  if(answer) {
    ...
    if(currentQuiz < quizData.length) {
      ...
      <button onclick='window.location.href="protein.html" '> Reload </button>
      `
